...
new_mat["child_CNVs"] = [
    ...
    for c, s, e in zip(new_mat["child_CNVs"], new_mat["start"], new_mat["end"])
]

new_mat["p1_CNVs"] = [
    remove_dup_null_outside(c, s, e)
    for c, s, e in zip(new_mat["p1_CNVs"], new_mat["start"], new_mat["end"])
]

new_mat["p2_CNVs"] = [
    remove_dup_null_outside(c, s, e)
    for c, s, e in zip(new_mat["p2_CNVs"], new_mat["start"], new_mat["end"])
]
